...
## Язык
Язык L(G[<условный оператор>], порождаемый грамматикой G[<условный оператор>]:
L(G[<условный оператор>]) = { IF условие THEN оператор }
## Классификация грамматики
Согласно классификации Хомского, грамматика G[E] является контекстно-свободной, так как имеет вид:
A → α, где A∈VN, α∈V*.
## Схема вызова
![Диаграмма без названия drawio](https://github.com/user-attachments/assets/901fd81b-3018-4dbb-a792-225c7249784d)

## Тестовые примеры
![image](https://github.com/user-attachments/assets/2674c31c-f167-4d40-b644-d47f45bfe5e2)
![image](https://github.com/user-attachments/assets/5f3639d8-f474-4f7e-b209-be92d5bc25f8)
