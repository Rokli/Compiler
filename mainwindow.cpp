    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->analysisMethod,&QAction::triggered,this,&MainWindow::aboutAnalysisMethod);
...
void MainWindow::aboutStateMentProblem(){
    openEmbeddedWordFile("statmentProblem");
}

void MainWindow::aboutClassificationGrammar(){
    openEmbeddedWordFile("classificationGrammar");
}

void MainWindow::aboutDiagnosticsAnalysisError(){
   openEmbeddedWordFile("diagnosticsAnalysisError");
}

void MainWindow::aboutGrammar(){
   openEmbeddedWordFile("Grammar");
}
void MainWindow::aboutReferences(){
    openEmbeddedWordFile("References");
}

void MainWindow::aboutSourceCodeProgramm(){
    openEmbeddedWordFile("SourceCodeProgramm");
}

void MainWindow::aboutTestCase(){
    openEmbeddedWordFile("TestCase");
}

void MainWindow::aboutAnalysisMethod(){
    openEmbeddedWordFile("AnalysisMethod");
}
...
void MainWindow::openEmbeddedWordFile(QString name) {
    QString resourcePath = ":/icons/icons/"+ name +".docx";

    QString tempDir = QStandardPaths::writableLocation(QStandardPaths::TempLocation);
    QString tempFilePath = tempDir + "/sample.docx";

    QFile inputFile(resourcePath);
    if (!inputFile.open(QIODevice::ReadOnly)) {
        qWarning() << "Не удалось открыть встроенный файл";
        return;
    }
